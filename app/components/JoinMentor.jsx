...
function JoinMentor() {
  return (
        ...
        <div class="flex flex-row bg-snow w-full">
            ...
            <div className='w-full px-4 py-16'>
                ...
                <div>
                    <h2 className=" pt-10 text-davysgray font-bold inline-flex text-xl">
                        <FaCheckCircle className="mr-2 m-auto text-red-400" />Best Courses
                    </h2>
                </div>

                <h2 className=" pt-8 text-davysgray font-bold inline-flex text-xl">
                    <FaCheckCircle className="mr-2 m-auto text-red-400" />Top rated Instructors
                </h2>
