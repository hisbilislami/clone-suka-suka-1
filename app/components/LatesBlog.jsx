    ...
    <div className="h-[100vh] w-full pt-10 bg-snow">
      ...
      <div className="flex flex-wrap">
        <div className="w-full px-10 lg:w-1/2 xl:w-1/4 ">
            ...
            <p className="text-sm text-center text-[#002058] -mt-8 mb-6">Courses</p>
            <div className="text-center">
                <p className="text-sm text-center text-[#002058] inline-flex mb-6 -mt-2">
                <FaCalendarAlt className="mr-2 m-auto text-red-400" />January 12, 2023
                </p>
            </div>
            </div>
        </div>
        <div className="w-full px-10 lg:w-1/2 xl:w-1/4 ">
            ...
            <p className="text-sm text-center text-[#002058] -mt-8 mb-6">Education</p>
            <div className="text-center">
                <p className="text-sm text-center text-[#002058] inline-flex mb-6 -mt-2">
                <FaCalendarAlt className="mr-2 m-auto text-red-400" />January 12, 2023
                </p>
        ...
        <div className="w-full px-10 lg:w-1/2 xl:w-1/4 ">
            ...
            <p className="text-sm text-center text-[#002058] -mt-8 mb-6">Business</p>
            <div className="text-center">
                <p className="text-sm text-center text-[#002058] inline-flex mb-6 -mt-2">
                <FaCalendarAlt className="mr-2 m-auto text-red-400" />January 12, 2023
                </p>
        ...
        <div className="w-full px-10 lg:w-1/2 xl:w-1/4 ">
            ...
            <p className="text-sm text-center text-[#002058] -mt-8 mb-6">Grapics Design</p>
            <div className="text-center">
                <p className="text-sm text-center text-[#002058] inline-flex mb-6 -mt-2">
                <FaCalendarAlt className="mr-2 m-auto text-red-400" />January 12, 2023
                </p>
