            ...
            <div className="container mx-auto w-full">
                <div className="flex flex-wrap ">
                    <div className="w-full px-8 py-5 xl:w-1/4 ">
                        ...
                        <div className="flex">
                            ...
                            <p className=" mt-2 px-2 text-white"> 7765, karanganyar, Paiton, Probolinggo, Jawa Timur</p>
                        </div>
                    ...
                    <div className="w-full px-8 py-5 xl:w-1/4 ">
                        ...
                        <ul>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Profile</a>
                            </li>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Login</a>
                            </li>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Register</a>
                            </li>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Instructor</a>
                            </li>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Dashboard</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="w-full px-8 py-5 xl:w-1/4 ">
                        ...
                        <ul>
                            ...
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Student</a>
                            </li>
                            <li className="text-white py-2">
                                <a href="#" className="inline-block text-base hover:text-ungu">Dashboard</a>
                            </li>
                ...
                <div className="w-full mt-24 border-t border-slate-50">
                    <div className="flex justify-between">
                        ...
                        <p className="text-white py-4 text-right"> @clone suka suka 2023. All rights reserved. </p>
